...
string GlobalParams::deft_vl_lut_filename;
...
bool GlobalParams::drain_mode_enabled;
int GlobalParams::drain_source_cutoff_cycles;
int GlobalParams::drain_timeout_cycles;
string GlobalParams::drain_stop_reason;
int GlobalParams::drain_measurement_start_cycle;
int GlobalParams::drain_source_cutoff_cycle;
int GlobalParams::drain_start_cycle;
int GlobalParams::drain_sources_quiesced_cycle;
int GlobalParams::drain_completed_cycle;
int GlobalParams::drain_stop_cycle;
